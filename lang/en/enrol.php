...
/**
 * Strings for component 'core_enroll', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    core_enroll
 * @subpackage enroll
...
$string['defaultenroll'] = 'Add instance to new courses';
...
$string['errajaxfailedenroll'] = 'Failed to enroll user';
$string['errajaxsearch'] = 'Error when searching users';
$string['erroreditenrollment'] = 'An error occurred while trying to edit a users enrollment';
...
$string['extremovedunenroll'] = 'Unenroll user from course';
