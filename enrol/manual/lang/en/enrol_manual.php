...
$string['manual:enroll'] = 'Enrol users';
$string['manual:manage'] = 'Manage user enrolments';
$string['manual:unenroll'] = 'Unenroll users from the course';
...
$string['wscannotenroll'] = 'Plugin instance cannot manually enroll a user in the course id = {$a->courseid}';
