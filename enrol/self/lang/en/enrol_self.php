...
$string['canntenroll'] = 'Enrolment is disabled or inactive';
...
$string['confirmbulkdeleteenrollment'] = 'Are you sure you want to delete these user enrolments?';
...
$string['groupkey_help'] = 'In addition to restricting access to the course to only those who know the key, use of group enrollment keys means users are automatically added to groups when they enroll in the course.
...
$string['status_help'] = 'If enabled together with \'Allow new enrolments\' disabled, only users who self enrolled previously can access the course. If disabled, this self enrollment method is effectively disabled, since all existing self enrolments are suspended and new users cannot self enroll.';
