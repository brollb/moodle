...
$string['flatfile:unenroll'] = 'Unenroll users from the course manually';
...
$string['privacy:metadata:enrol_flatfile'] = 'The Flat file (CSV) enrollment plugin may store personal data relating to future enrolments in the enrol_flatfile table.';
$string['privacy:metadata:enrol_flatfile:action'] = 'The enrollment action expected on the given date';
$string['privacy:metadata:enrol_flatfile:courseid'] = 'The course ID to which the enrollment relates';
$string['privacy:metadata:enrol_flatfile:roleid'] = 'The ID of the role to be assigned or unassigned';
$string['privacy:metadata:enrol_flatfile:timestart'] = 'The time when the enrollment starts';
$string['privacy:metadata:enrol_flatfile:timeend'] = 'The time when the enrollment ends';
$string['privacy:metadata:enrol_flatfile:timemodified'] = 'The time when the enrollment is modified';
