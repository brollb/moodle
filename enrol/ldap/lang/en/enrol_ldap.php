...
$string['emptyenrollment'] = "Empty enrollment for role '{\$a->role_shortname}' in course '{\$a->course_shortname}'\n";
...
$string['extremovedunenroll'] =  "Unenroll user '{\$a->user_username}' from course '{\$a->course_shortname}' (id {\$a->course_id})";
