...
$string['meta:unenroll'] = 'Unenroll suspended users';
...
$string['pluginname_desc'] = 'Course meta link enrollment plugin synchronises enrolments and roles in two different courses.';
...
$string['wsinvalidcourse'] = 'Course id = {$a} does not exist or no permission to link in meta enrollment.';
$string['wsinvalidmetacourse'] = 'Meta course id = {$a} does not exist or no permission to add enrollment instance.';
