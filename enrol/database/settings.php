...
/**
 * Database enrollment plugin settings and presets.
 *
...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configselect('enrol_database/unenrolaction', get_string('extremovedaction', 'enroll'), get_string('extremovedaction_help', 'enroll'), ENROL_EXT_REMOVED_UNENROL, $options));
