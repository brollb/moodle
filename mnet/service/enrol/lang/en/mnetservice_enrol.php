...
$string['clientname_help'] = 'This tool allows you to enroll and unenroll your local users on remote hosts that allow you to do so via the \'MNet remote enrolments\' plugin.';
...
$string['privacy:metadata:mnetservice_enrol_enrolments:enroltime'] = 'The time when the enrollment was modified';
$string['privacy:metadata:mnetservice_enrol_enrolments:enroltype'] = 'The enrollment type on the remote server used to enroll the user in their course';
...
$string['privacy:metadata:mnetservice_enrol_enrolments:tableexplanation'] = 'The Remote enrollment service stores information about enrolments of local users in courses on remote hosts.';
