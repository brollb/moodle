...
Feature: An admin can update courses enrolments using a CSV file
  ...
  As an admin
  I need to be able to upload a CSV file with enrollment methods for the courses
  ...
  @javascript
  Scenario: Creating enrollment method by enable it
    Given I am on the "Course 1" "enrollment methods" page
  ...
  @javascript
  Scenario: Creating enrollment method by disabling it
    Given I am on the "Course 1" "enrollment methods" page
    And I click on "Delete" "link" in the "Guest access" "table_row"
    And I click on "Continue" "button"
    And I should not see "Guest access" in the "generaltable" "table"
  ...
  @javascript
  Scenario: Enabling enrollment method
  ...
  @javascript
  Scenario: Disable an enrollment method
    Given I am on the "Course 1" "enrollment methods" page
  ...
  @javascript
  Scenario: Delete an enrollment method
    Given I navigate to "Courses > Upload courses" in site administration
  ...
  @javascript
  Scenario: Delete an unexistent enrollment method (nothing should change)
    Given I am on the "Course 1" "enrollment methods" page
    And I click on "Delete" "link" in the "Guest access" "table_row"
    And I click on "Continue" "button"
    And I should not see "Guest access" in the "generaltable" "table"
