...
$string['privacy:metadata:preference:grade_report_showonlyactiveenroll'] = 'Whether to display only active enrolled users (not suspended) in gradebook report or all the enrolled users';
